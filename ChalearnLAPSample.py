...
class GestureSample(object):
    ...
    def __init__ (self,fileName,validation = 0):
        ...
        if validation == 0: 
            ...
            labelsPath="/home/jzhang/SciSoft/data/ValidLabel"+os.path.sep + self.seqID + '_labels.csv'
#         labelsPath="/home/jzhang/SciSoft/code/oCVPR/training/gt"+os.path.sep + self.seqID + '_labels.csv'
#         labelsPath="/home/jzhang/SciSoft/data/ValidLabel"+os.path.sep + self.seqID + '_labels.csv'
