...
### theano import
sys.path.append(r'/home/chaoyu/cuda-workspace/jiaweiDBN/TheanoDL')
import theano
...
data_path=os.path.join("/research/tklab/personal/haoyu/ChalearnDB/trail/test1/")  
# Predictions folder (output)
outPred=os.path.join("/research/tklab/personal/haoyu/ChalearnDB/trail/pred1/") 
...
#         gesturesList=smp.getGestures()
        ...
        dbn.load('dbn_2016-08-19-14-01-49.npy')
        ...
        dbn = GRBM_DBN(numpy_rng=numpy_rng, n_ins=528,
            ...
            n_outs=class_count*10+1, finetune_lr=0.1)
        dbn.load('dbn_2016-08-19-05-59-37.npy')
...
#         log_observ_likelihood = log(observ_likelihood_1.T) + log(observ_likelihood_3.T)
        ...
        [pred_label, begin_frame, end_frame, Individual_score, frame_length] = viterbi_colab_clean(path, global_score, threshold=-20, mini_frame=19)
...
TruthDir = "/research/tklab/personal/haoyu/ChalearnDB/trail/testlabel1/"
