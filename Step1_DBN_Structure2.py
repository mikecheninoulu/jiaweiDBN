...
import numpy
import sys
sys.path.append(r'/home/jzhang/SciSoft/gestureReco21/TheanoDL')
...
#     model 1
    dbn = GRBM_DBN(numpy_rng=numpy_rng, n_ins=528, hidden_layers_sizes=[1000, 1000, 500], n_outs=211, finetune_lr=0.1)
